...
import ca.uqtr.locationhabitat.authservice.service.JwtService;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        try {
            ...
            final String courriel = jwtService.extractCourriel(jwt);

            if (courriel != null && SecurityContextHolder.getContext().getAuthentication() == null) {
                UserDetails userDetails = customUserDetailsService.loadUserByUsername(courriel);
